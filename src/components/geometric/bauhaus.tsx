...
const BauhausPattern = () => {
  ...
  // Add initialPattern state to store the first render pattern
  ...
  }, [state, metaControls, params, generateRandomParams]);
  ...
  useEffect(() => {
    setIsHydrated(true);
    setState(s => ({ ...s, isAnimating: true })); // Start animation after hydration
  }, []);
